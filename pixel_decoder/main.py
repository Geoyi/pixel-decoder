...
def parse_args(args):
    ...
    parser.add_argument('-shape', '--origin_shape_no', help='the image shape of the input training images', default=256, required=False)
    parser.add_argument('-border', '--border_no', help='pixels number to add on training image and mask to get rid of edge effects from unet', default=32, required=False)
    ...
    parser.add_argument('-bord', '--border_no', help='pixels number to add on training image and mask to get rid of edge effects from unet', type=int, default=32, required=False)
    parser.add_argument('-chns', '--channel_no', help='RGB three color channels for the training', default=3, type=int, required=False)
